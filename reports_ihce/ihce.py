...
class reports_recepcion(osv.osv_memory):
    ...
    def action_create_report(self, cr, uid, ids, context=None):
        ...
        worksheet.write('C7', 'Edad', styleT)
        worksheet.write('D7', 'Sexo', styleT)
        worksheet.write('E7', 'Correo', styleT)
        worksheet.write('F7', 'Telefono', styleT)
        worksheet.write('G7', 'Fecha', styleT)
        ...
        worksheet.write('C'+str(i+10), 'Mujeres', styleT)
        worksheet.write_column('D'+str(i+10), [mujeres])
        ...
        worksheet.insert_chart('H'+str(9), chart)
...
class reports_numeralia(osv.osv_memory):
    ...
    def action_create_report(self, cr, uid, ids, context=None):
        ...
        styleTitulos = workbook.add_format({'font_color': 'black', 'align': 'horizontal center', 'font_size':12, 'border': 0, 'align':'left', 'bg_color':'#d7eedb', })
        ...
        worksheet.write('E2'," Al  "+str(data.date_fin), styleT)
        #worksheet.write('F4', date_time, date_format) 

        worksheet.write('A6', 'No.', styleTitulos)
        worksheet.write('B6', 'No.', styleTitulos)
        worksheet.write('C6', '', styleTitulos)
        worksheet.write('D6', '', styleTitulos)
        worksheet.write('E6', 'Financiamiento(Pesos)', styleTitulos)
        worksheet.write('F6', '', styleTitulos)
        worksheet.write('G6', '', styleTitulos)
        worksheet.write('H6', '', styleTitulos)
        worksheet.write('I6', '', styleTitulos)
        worksheet.write('J6', 'Empresa o Emprendor Participante', styleTitulos)
        worksheet.write('K6', '', styleTitulos)
        worksheet.write('L6', '', styleTitulos)
        worksheet.write('M6', '', styleTitulos)
        worksheet.write('N6', '', styleTitulos)
        worksheet.write('O6', '', styleTitulos)
        worksheet.write('P6', '', styleTitulos)
        worksheet.write('Q6', '', styleTitulos)
        worksheet.write('R6', '', styleTitulos)
        worksheet.write('S6', '', styleTitulos)
        worksheet.write('T6', '', styleTitulos)
        worksheet.write('U6', '', styleTitulos)
        worksheet.write('V6', '', styleTitulos)
        worksheet.write('W6', '', styleTitulos)



        worksheet.write('A7', '', styleTitulos)
        worksheet.write('B7', '', styleTitulos)
        worksheet.write('C7', 'Secretaria/Organismo', styleTitulos)
        worksheet.write('D7', 'Nombre del curso', styleTitulos)
        worksheet.write('E7', 'Estatal', styleTitulos)
        worksheet.write('F7', 'Federal', styleTitulos)
        worksheet.write('G7', 'Privado', styleTitulos)
        worksheet.write('H7', '', styleTitulos)
        worksheet.write('I7', 'Empresario', styleTitulos)
        worksheet.write('J7', '', styleTitulos)
        worksheet.write('K7', 'Emprendedor', styleTitulos)
        worksheet.write('L7', '', styleTitulos)
        worksheet.write('M7', 'Otro', styleTitulos)
        worksheet.write('N7', '', styleTitulos)
        worksheet.write('O7', 'Nombre o Razon Social', styleTitulos)
        worksheet.write('P7', 'RFC', styleTitulos)
        worksheet.write('Q7', 'Municipio', styleTitulos)
        worksheet.write('R7', 'Giro', styleTitulos)
        worksheet.write('S7', 'Con actividades Cientificas', styleTitulos)
        worksheet.write('T7', 'Producto o Servicio Principal', styleTitulos)
        worksheet.write('U7', 'Empleador', styleTitulos)
        worksheet.write('V7', 'Subordinados', styleTitulos)
        worksheet.write('W7', 'Fecha del Rerporte', styleTitulos)
        

        worksheet.write('A8', '', styleTitulos)
        worksheet.write('B8', '', styleTitulos)
        worksheet.write('C8', '', styleTitulos)
        worksheet.write('D8', '', styleTitulos)
        worksheet.write('E8', '', styleTitulos)
        worksheet.write('F8', '', styleTitulos)
        worksheet.write('G8', '', styleTitulos)
        worksheet.write('H8', 'Total', styleTitulos)
        worksheet.write('I8', 'Hombre', styleTitulos)
        worksheet.write('J8', 'Mujer', styleTitulos)
        worksheet.write('K8', 'Hombre', styleTitulos)
        worksheet.write('L8', 'Mujer', styleTitulos)
        worksheet.write('M8', 'Hombre', styleTitulos)
        worksheet.write('N8', 'Mujer', styleTitulos)
        worksheet.write('O8', '', styleTitulos)
        worksheet.write('P8', '', styleTitulos)
        worksheet.write('Q8', '', styleTitulos)
        worksheet.write('R8', '', styleTitulos)
        worksheet.write('S8', '', styleTitulos)
        worksheet.write('T8', '', styleTitulos)
        worksheet.write('U8', '', styleTitulos)
        worksheet.write('V8', '', styleTitulos)
        worksheet.write('W8', '', styleTitulos)


        courses_ids = self.pool.get('date.courses').search(cr, uid, [('date','>=',data.date_ini),('date','<=',data.date_fin), ('state','=','done')], context=None)
